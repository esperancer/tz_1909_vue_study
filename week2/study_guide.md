...
### 1.3 methos, v-on 디렉티브로 이벤트 적용하기(실습)

### 1.4 methos, v-bind를 이용한 CSS 스타일 적용하기(실습)




## 2. Vue의 컴포넌트 알아보기 (10:00 ~ 10:50)
...
데이터 전달은 부모에서 자식으로만 가능하다. (단방향) 양방향 컴포넌트 통신은 복잡성을 늘리기 때문에 이렇게 설계한 것으로 보입니다. 반면 자식은 부모에게 이벤트를 발신할 수 있다.
...
## 3. Vue의 컴포넌트 알아보기 / Vue의 컴포넌트간 데이터 전달 방식 이해하기 (11:00 ~ 11:50)

## 4. Vue 라우터 구성 방법 알아보기 / Axios 사용해보기 (12:00 ~ 12:50)

## 5. JWT(JSON Web Token) 알아보기 (12:00 ~ 12:50)
